...
- (void)initilization{
    ...
    trashImageAry = [[NSArray alloc]initWithObjects:
                     [UIImage imageNamed:@"recorder_trash_can0.png"],
                     [UIImage imageNamed:@"recorder_trash_can1.png"],
                     [UIImage imageNamed:@"recorder_trash_can2.png"],
                     [UIImage imageNamed:@"recorder_trash_can1.png"], nil];
}
...
- (void)rockTrashCan:(BOOL)_isTure{
    if (_isTure != isTrashCanRocking) {
        ...
        if (isTrashCanRocking) {
            ...
            _trashCanIV.image = [UIImage imageNamed:@"recorder_trash_can0.png"];
        }
    }
}
