...
typedef enum {
    CycleScrollViewCellTitleLabelRight,  //右边偏上
    CycleScrollViewCellTitleLabelBottom  //底部
} CycleScrollViewCellTitleLabelStyle;
...
@property (nonatomic, assign) CycleScrollViewCellTitleLabelStyle titleLabelStyle;
