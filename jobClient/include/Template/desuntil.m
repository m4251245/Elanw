...
//+ (NSString *) udid
//{
//return [desuntil encryptStr:[[UIDevice currentDevice] uniqueIdentifier]];
//}
...
{
	return [desuntil doCipher:str key:_key context:kCCEncrypt];
}
...
+ (NSString *)doCipher:(NSString *)sTextIn key:(NSString *)sKey
    ...
    if (encryptOrDecrypt == kCCDecrypt) {    
        dTextIn = [[desuntil decodeBase64WithString:sTextIn] mutableCopy];    
    }    
    else{    
    ...
    if (encryptOrDecrypt == kCCDecrypt){    
        ...
        sResult = [desuntil encodeBase64WithData:dResult];    
    }           
    return sResult;
}
...
+ (NSString *)encodeBase64WithString:(NSString *)strData {
	return [desuntil encodeBase64WithData:[strData dataUsingEncoding:NSUTF8StringEncoding]];
}
