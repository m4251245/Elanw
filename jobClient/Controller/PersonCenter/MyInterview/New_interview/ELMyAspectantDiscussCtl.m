...
{
    [con getAspectantDisListWithUserId:[Manager getUserInfo].userId_ status:productType page:con.pageInfo_.currentPage_ pageSize:20 otherCond:@""];
}
...
-(void)loadDetail:(id)selectData exParam:(id)exParam indexPath:(NSIndexPath *)indexPath
{
    ...
    ELMyAspectantDetailCtl *detailCtl = [[ELMyAspectantDetailCtl alloc] init];
