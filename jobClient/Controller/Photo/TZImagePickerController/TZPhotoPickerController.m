...
@interface TZPhotoPickerController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIAlertViewDelegate,PhotoBrowerDelegate> {
...
//        browerCtl.selectedAssets = [NSMutableArray arrayWithArray:_models];
