...
@interface CondictionTradeCtl : PreBaseUIViewController<UITableViewDelegate,UITableViewDataSource> {
...
//+ (void)archiverTradeName:(NSString *)tradeName tradeId:(NSString *)tradeId tradePId:(NSString *)tradePid;
