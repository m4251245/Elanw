...
@property (nonatomic, assign) NSInteger  commentIndex;     //区分评论

- (void)setEmojiAttributedText:(NSMutableAttributedString*)emojiTextAttributedString emojiText:(NSString *)emojiText;  //设置AttributedText
@end
